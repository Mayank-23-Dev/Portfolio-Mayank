...
const xc = () => {
  ...
  Fe = "https://www.nischalskanda.tech",
  en = "Mayank Dev Portfolio",
  Xe = "/website-preview-og.png",
  Pc =
    "Preview of Mayank Dev portfolio showcasing product design case studies and selected work.",
  Pr = "@Mayank_Dev23",
  P = {
    home: "/",
    projects: "/projects",
  ...
  jt = {
    ...
    sameAs: [
      ...
      "https://dribbble.com/nischalskanda",
      "https://www.behance.net/nischalskanda",
    ],
  },
  ...
  Rc = [
    {
      path: P.home,
      title: "Mayank Dev | Product Designer Portfolio",
      description:
        "Product designer improving products through clear systems, thoughtful UX, and high-signal case studies.",
      keywords: oe(se, [
    ...
    },
    {
      ...
      description:
        "An editorial look at the path behind Mayank Dev’s design work, from computer science foundations to research-led product design and shipped systems.",
      keywords: oe(se, [
        "Life Story",
    ...
    {
      path: P.journey,
      title: "Design Journey | Mayank Dev",
      description:
        "A structured alternate reading mode for the story behind Mayank Dev’s design work, with prose, list, and timeline views.",
      keywords: oe(se, [
        "Design Journey",
        "Product Designer Story",
        "Career Path",
        "Design Background",
      ]),
      canonicalPath: P.life,
